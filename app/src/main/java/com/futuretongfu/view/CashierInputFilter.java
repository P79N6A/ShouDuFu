...
//                if (dstart>=1&&(!destText.equals("0")&&!sourceText.equals("."))&&Integer.parseInt(sourceText)>0) {
//                    return "";
//                }
                if (dstart>=1){
                    if (!destText.equals("0")&&!sourceText.equals(".")&&Integer.parseInt(sourceText)>0){
                        return "";
                    }
                    if (!destText.equals("0")&&!destText.equals("1")&&!sourceText.equals(".")&&Integer.parseInt(sourceText)>=0){
                        return "";
                    }
                }
