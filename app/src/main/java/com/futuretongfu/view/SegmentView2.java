...
/**
 * Created by zhanggf on 2018/4/8.
 */
...
//		this.setLayoutParams(new LinearLayout.LayoutParams(dp2Px(getContext(), 60), LinearLayout.LayoutParams.WRAP_CONTENT));
        ...
        @SuppressLint("ResourceType") XmlPullParser xrp = getResources().getXml(R.drawable.seg_text_color_selector2);
        try {
        ...
        textView1.setPadding(45, 8, 45, 8);
        textView2.setPadding(45, 8, 45, 8);
        setSegmentTextSize(16);
        textView1.setBackgroundResource(R.drawable.seg_left2);
        textView2.setBackgroundResource(R.drawable.seg_right2);
