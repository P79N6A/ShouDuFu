 ...
 */
public class UpgradePopupWindow extends PopupWindow implements View.OnClickListener, IEditAddressView {
        ...
        aearListAdapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                ...
                if (popupWindowListener != null) {
                    popupWindowListener.onChooseFinish(proviceString, proviceId,cityString, cityId,aearString,aearCode);
                    dismiss();
                }
            }
        });
    ...
    public interface PopupWindowListener {
        //键盘输入完
        void onChooseFinish(String provices,String proviceId, String city,String cityId, String area,String aearCode);
    }
