...
public class WheelView extends TosGallery{
    ...
    private void initialize(Context context) {
        ...
        this.mTopShadow = new GradientDrawable(GradientDrawable.Orientation.TOP_BOTTOM,
                SHADOWS_COLORS);
        this.mBottomShadow = new GradientDrawable(GradientDrawable.Orientation.BOTTOM_TOP,
                SHADOWS_COLORS);
