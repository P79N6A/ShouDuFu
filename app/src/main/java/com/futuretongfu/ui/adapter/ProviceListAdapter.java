 ...
 */
public class ProviceListAdapter extends BaseQuickAdapter<AddressEntity, BaseViewHolder> {

    private Context context;
    List<AddressEntity> list;

    public ProviceListAdapter(@LayoutRes int layoutResId, @Nullable List<AddressEntity> list) {
