...
/**
 * Created by zhanggf on 2018/5/2.
 */

public class MyAttentionAdapter extends BaseQuickAdapter<FavoriteList, BaseViewHolder> {

    private Context context;

    public MyAttentionAdapter(Context context, MyCollectionAdapterListener myCollectionAdapterListener, @Nullable List<FavoriteList> datas) {
    ...
    protected void convert(final BaseViewHolder helper, final FavoriteList item){
        ...
        GlideLoad.loadCrossFadeImageView(item.getLogoUrl(), ingvPic);
