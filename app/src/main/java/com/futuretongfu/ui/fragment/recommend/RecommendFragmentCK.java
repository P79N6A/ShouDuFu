 ...
 */
public class RecommendFragmentCK extends BaseFragment implements IRecommendListView, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void init(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        typeId = 3;
        getRecommendList();
        //myRecommendActivity.setTitlesForIndex(2, "创客(2)");
    }
