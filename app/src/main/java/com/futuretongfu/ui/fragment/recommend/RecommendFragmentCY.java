 ...
 * 描述:  创业
 * 作者： weiang on 2018/8/31
 */
public class RecommendFragmentCY extends BaseFragment implements IRecommendListView, BaseQuickAdapter.RequestLoadMoreListener {
    ...
    protected void init(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        typeId = 0;
        getRecommendList();
        //myRecommendActivity.setTitlesForIndex(0,"创投(3)");
    }
