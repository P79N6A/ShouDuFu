 ...
 */
public class RecommendFragmentXC extends BaseFragment implements IRecommendListView, BaseQuickAdapter.RequestLoadMoreListener {
     ...
     * 获取推荐列表
     */
    public void getRecommendList(int pageNumber) {
