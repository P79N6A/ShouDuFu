...
package com.skjr.zxinglib.camera;
...
import com.skjr.zxinglib.PlanarYUVLuminanceSource;
import com.skjr.zxinglib.PreferenceConfig;
        ...
        if (framingRect == null) {
            if (camera == null) {
                ...
                try {
                    ...
                    int width = context.getResources().getDisplayMetrics().widthPixels * 3 / 5;
                    int height = width;
